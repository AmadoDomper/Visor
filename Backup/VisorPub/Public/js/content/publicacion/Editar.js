...
function llenarDatos() {
    $('#txtTitulo').val(Model.publicacion.pub_titulo);
    $('#ddlTipo').val(Model.publicacion.oTipo.tip_idtipo);
    var lsTemasst=Array();
    ...
    $('#txtAnoPublicacion').val(Model.publicacion.pub_anopublicacion);
    $('#txtEnlace').val(Model.publicacion.pub_enlace);
    $('#txtReferencia').val(Model.publicacion.pub_referenciabibliografica);
    for (var i = 0; i < Model.publicacion.lsFeatures.length; i++) {
        var punto = Model.publicacion.lsFeatures[i].Info.split(' ');
    ...
    $('#btenviar').click(function () {
        ...
        if ($('#frm').smkValidate()) {
            $.fn.Conexion({
                ...
                bloqueo: true,
                datos: {
                    "pub_idpublicacion": Model.publicacion.pub_idpublicacion,
                    ...
                    "ls_tem_idtema": $('#ddlTema').val().join(','),
