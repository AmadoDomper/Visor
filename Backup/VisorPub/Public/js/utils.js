                        ...
                        '<div class="modal-content">' +
                            ...
                            '<div class="modal-body">' +
                                ...
                                '<div class="row">' +
                                      ...
                                      '<div class="col-md-6"><div class="form-group"><label>Lat: </label><input type="text" class="form-control" placeholder="Lat" id="mdaddpoint_lat"></div></div>' +
                                      '<div class="col-md-6"><div class="form-group"><label>Lng: </label><input type="text" class="form-control" placeholder="Lng" id="mdaddpoint_lng"></div></div>' +
